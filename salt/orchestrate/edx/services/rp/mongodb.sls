...
resize_root_device_to_use_full_disk:
  salt.state:
    - tgt: 'G@roles:mongodb and G@environment:mitx-rp'
    - tgt_type: compound
    - sls:
...
build_mongodb_nodes:
  salt.state:
    - tgt: 'G@roles:mongodb and G@environment:mitx-rp and not G@roles:mongodb_primary'
    - tgt_type: compound
    - highstate: True
    - require:
...
build_mongodb_master_node:
  salt.state:
    - tgt: 'G@roles:mongodb_primary and G@environment:mitx-rp'
    - tgt_type: compound
    - highstate: True
    - require:
        - salt: populate_mine_with_mongodb_node_data
