          ...
          config:
            ...
            - server:
                ...
                - listen:
                    - '[::]:443'
                    - ssl
                - root: /ocwdata/apache-tomcat/webapps/
                - ssl_certificate: /etc/letsencrypt/live/{{ server_domain_names }}/fullchain.pem
                - ssl_certificate_key: /etc/letsencrypt/live/{{ server_domain_names }}/privkey.pem
                - ssl_stapling: 'on'
