      ...
      {{ app_name }}:
        ...
        config:
          ...
          - server:
              ...
              - set $authorized: 'no'
              - if ($ssl_client_s_dn ~ "emailAddress=(tmacey|pdpinch|shaidar|ichuang|gsidebo|mkdavies|gschneel|mattbert|nlevesq|ferdial|briangro|annagav|mbrdlove|jmartis|abeglova|gumaerc)@MIT.EDU"):
                - set $authorized: 'yes'
              - if ($authorized !~ "yes"):
                - return: 403
