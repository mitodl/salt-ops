...
{% set env_dict = {
    'ci': {
      ...
      'CORS_URLS': ['https://micromasters-ci.odl.mit.edu', 'https://ocwnext-rc.odl.mit.edu'],
      'DEBUG': False,
    ...
    'rc': {
      ...
      'CORS_URLS': ['https://micromasters-rc.odl.mit.edu', 'https://ocwnext-rc.odl.mit.edu', 'https://ocw-next.netlify.app', 'https://ocwnext-rc.odl.mit.edu', 'https://ol-devops-ci.odl.mit.edu'],
      'DEBUG': False,
    ...
    'production': {
      ...
      'CORS_URLS': ['https://micromasters.mit.edu', 'https://ocwnext.odl.mit.edu', 'https://ocw-beta.odl.mit.edu', 'https://ocw-preview.odl.mit.edu', 'https://ocw-published.odl.mit.edu', "https://www.ocw.mit.edu", "https://ocw.mit.edu",],
      'DEBUG': False,
      'env_name': 'production',
