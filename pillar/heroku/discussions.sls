...
{% set env_dict = {
    ...
    'rc': {
      ...
      'CORS_URLS': ['https://micromasters-rc.odl.mit.edu', 'https://ocwnext-rc.odl.mit.edu', 'https://ocw-next.netlify.app', 'https://ocwnext-rc.odl.mit.edu', 'https://ol-devops-ci.odl.mit.edu', 'https://draft-qa.ocw.mit.edu', 'https://live-qa.ocw.mit.edu'],
      'DEBUG': False,
