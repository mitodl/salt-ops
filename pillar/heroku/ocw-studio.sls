...
{% set env_dict = {
    'ci': {
      ...
      'OPEN_CATALOG_URLS': 'https://discussions-ci.odl.mit.edu,https://mitopen-rc.odl.mit.edu',
    ...
    'rc': {
      ...
      'OPEN_CATALOG_URLS': 'https://discussions-rc.odl.mit.edu,https://mitopen-rc.odl.mit.edu',
    ...
    'production': {
      ...
      'OPEN_CATALOG_URLS': 'https://open.mit.edu,https://mitopen.odl.mit.edu',
