...
{% set env_dict = {
    'ci': {
      ...
      'FEATURE_SELECT_FIELD_PRESERVE_SEARCH_TEXT': 'True',
    ...
    'production': {
      ...
      'FEATURE_SELECT_FIELD_PRESERVE_SEARCH_TEXT': 'False',
...
heroku:
  ...
  config_vars:
    ...
    FEATURE_SELECT_FIELD_PRESERVE_SEARCH_TEXT: {{ env_data.FEATURE_SELECT_FIELD_PRESERVE_SEARCH_TEXT }}
