...
{% set env_dict = {
    ...
    'rc': {
      'app_log_level': 'INFO',
      'app_name': 'ol-mit-open-rc', # MODIFIED
      'CELERY_WORKER_MAX_MEMORY_PER_CHILD': 125000,      
      'CLOUDFRONT_DIST': 'd1d3xcwjqmwwj2', # UPDATE
      ...
      'NEW_RELIC_APP_NAME': 'discussions-rc', # UPDATE
      'MAILGUN_SENDER_DOMAIN': 'discussions-mail.odl.mit.edu', # UPDATE?
      ...
      'OCW_NEXT_LIVE_BUCKET': 'ocw-content-live-qa',
      'OCW_UPLOAD_IMAGE_ONLY': True,
      'OPEN_DISCUSSIONS_BASE_URL': 'https://discussions-rc.odl.mit.edu',  # UPDATE
      'OPEN_DISCUSSIONS_COOKIE_NAME': 'discussionsrc',  # UPDATE
      'OPEN_DISCUSSIONS_COOKIE_DOMAIN': 'odl.mit.edu',  # UPDATE?
      'OPEN_DISCUSSIONS_SUPPORT_EMAIL': 'odl-discussions-rc-support@mit.edu', # UPDATE?
      'OPENSEARCH_INDEX': 'discussions-rc', # UPDATE
      'OPENSEARCH_SHARD_COUNT': 2,
      ...
      'SOCIAL_AUTH_SAML_SP_ENTITY_ID': 'https://discussions-rc.odl.mit.edu/saml/metadata', # UPDATE
