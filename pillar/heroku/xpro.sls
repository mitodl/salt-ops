...
{% set env_dict = {
    'ci': {
      ...
      'logout_redirect_url': 'https://courses-qa-sandbox.xpro.mit.edu/logout',
      'OPENEDX_API_BASE_URL': 'https://courses-qa-sandbox.xpro.mit.edu',
    ...
    'rc': {
      ...
      'logout_redirect_url': 'https://courses-qa.xpro.mit.edu/logout',
      'OPENEDX_API_BASE_URL': 'https://courses-qa.xpro.mit.edu',
      'openedx_environment': 'mitxpro-qa',
      'CYBERSOURCE_SECURE_ACCEPTANCE_URL': 'https://testsecureacceptance.cybersource.com/pay',
      'CYBERSOURCE_WSDL_URL': 'https://ics2wstest.ic3.com/commerce/1.x/transactionProcessor/CyberSourceTransaction_1.154.wsdl',
