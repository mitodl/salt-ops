...
{% set cert = salt.vault.cached_write('pki-intermediate-operations-qa/issue/fluentd-server', common_name='operations-fluentd.query.consul', ttl='720h', cache_prefix=minion_id) %}
