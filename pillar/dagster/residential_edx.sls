      ...
      solids:
        export_edx_forum_database:
          config:
            ...
            edx_mongodb_password: __vault__:cache:mongodb-{{ mitx_environment }}/creds/readonly>data>password
            edx_mongodb_username: __vault__:cache:mongodb-{{ mitx_environment }}/creds/readonly>data>username
