...
kibana:
  lookup:
    ...
    nginx_extra_config_list:
      ...
      - set $authorized "no";
      - if ($ssl_client_s_dn ~ "/emailAddress=(tmacey|pdpinch|shaidar|ichuang|gsidebo|mkdavies|gschneel|mattbert|nlevesq|ferdial|maxliu|annagav|mbrdlove)@MIT.EDU") { set $authorized "yes"; }
